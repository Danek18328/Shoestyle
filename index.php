...
// Guardar reseña si se envió el formulario
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Redirigir para evitar mensaje y resubmit
...
<header class="banner-portada">
    ...
    <div class="contenido-centro">
        ...
        <p class="subtitulo">
            Descubre la mejor colección de calzado urbano, deportivo y casual. <br>
    ...
    <div class="scroll-indicator">
        ...
        <main>
            ...
            <p>En SHOESTYLE te ofrecemos lo mejor en calzado para toda ocasión. Encuentra zapatillas, botas, tacones y más, con la mejor calidad y al mejor precio. Navega por nuestras secciones y encuentra tu estilo.</p>
<br>
<br>
...
<section>
            ...
            <article class="carrusel" id="carrusel-zapatos">
                <button class="flecha izq" onclick="moverCarrusel('zapatos', -1)">&#10094;</button>
                <img id="zapato-imagen" src="./imagenes/negras.webp" alt="Zapato catálogo">
                <button class="flecha der" onclick="moverCarrusel('zapatos', 1)">&#10095;</button>
            </article>
</section>
...
<article class="productos">
    ...
    <div class="producto">
        <img src="./PHP/uploads/Captura de pantalla 2025-04-30 144904.png" alt="Zapato Clásico Mujer">
        ...
        <article class="reseñas">
            ...
            if ($resultado->num_rows > 0) {
                while ($row = $resultado->fetch_assoc()) {
                    ...
                    echo "<h3>" . str_repeat("⭐️", $row['estrellas']) . "</h3>";
...
<footer>
    <div class="redes-sociales">
        ...
        <div class="iconos-redes">
            <a href="https://www.facebook.com/profile.php?id=61575560894613&locale=es_LA" target="_blank">
                <img src="./imagenes/facebook.png" alt="Facebook">
            </a>
            <a href="#"><img src="./imagenes/instagram.jpg" alt="Instagram"></a>
            <a href="https://vm.tiktok.com/ZSHtArvgSS6t6-bfRuv/" target="_blank">
                <img src="./imagenes/tiktok.png" alt="TikTok">
            </a>
            <a href="https://x.com/shoestyle397157" target="_blank">
                <img src="./imagenes/twitter.png" alt="Twitter">
            </a>
            <a href="https://chat.whatsapp.com/EopjMlzLqiFFMkKOCvCasU?mode=ems_copy_c" target="_blank">
    ...
    <div class="footer-info">
        <div class="columna">
            <h4>AYUDA</h4>
            <ul>
                <li><a href="https://chat.whatsapp.com/EopjMlzLqiFFMkKOCvCasU?mode=ems_copy_c">Asistencia</a></li>
                <li><a href="https://chat.whatsapp.com/EopjMlzLqiFFMkKOCvCasU?mode=ems_copy_c">Seguimiento de pedidos</a></li>
                <li><a href="https://chat.whatsapp.com/EopjMlzLqiFFMkKOCvCasU?mode=ems_copy_c">Envíos</a></li>
                <li><a href="https://chat.whatsapp.com/EopjMlzLqiFFMkKOCvCasU?mode=ems_copy_c">Devoluciones</a></li>
            </ul>
        </div>
        ...
        <div class="columna">
            <h4>SHOESTYLE</h4>
            <ul>
                <li><strong>Teléfonos:</strong> +57 310 700 1125 / +57 302 2001695</li>
                <li><strong>Correo:</strong> shoestyle@gmail.com</li>
                <li><strong>Horarios:</strong> 8:00 a.m - 7:00 p.m</li>
                <li><strong>Dirección:</strong> Por confirmar</li>
            </ul>
        </div>
        ...
        <div class="columna">
            ...
            <ul>
                <li><a href="./paginas/terminos.pdf" target="_blank">Términos y Condiciones</a></li>
    ...
    <div class="copyright">
        <p>&copy; 2025 SHOESTYLE. Todos los derechos reservados.</p>
    </div>
</footer>
...
<script>
    ...
    function moverCarrusel(tipo, direccion) {
        if (tipo === "zapatos") {
            indexZapato = (indexZapato + direccion + zapatos.length) % zapatos.length;
